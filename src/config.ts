...
export const site:SiteConfig = {
    // 你将要部署到的站点地址
    origin: 'https://it.xiaoayu.ren',
    // 站点图标链接
    favicon: '/iak.png',
    // 站点名称
    name: 'DEREK',
    // 站点标语
    slogan: '不专业的挨踢者，专业的打灰人',
    // 站点描述
    description: '不专业的挨踢者，专业的打灰人',
    // 站点关键词
    keywords: '学习,分享,跨学科学习,博客',
    // 站点作者
    author: 'DEREK'
}
export const author = {
...
export const footer: FooterConfig = {
    beian: {
        enabled: true,
        value: "萌ICP备20230989号"
    },
    slogan: "一个土木打灰人的小站",
    links: [
        {
            href: 'https://it.xiaoayu.ren',
            icon: '<img src="/images/dorakika.png" class="icon" alt="DEREK" />',
            title: 'DEREK'
        },
        {
            ...
            href: 'mailto:zhenyusun84@gmail.com',
